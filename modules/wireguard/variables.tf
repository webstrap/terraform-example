...
variable "wg_client_public_keys" {
  # type        = map(string) # TODO: what type is this currently, why is this commented out?
...
variable "eip_id" {
  description = "EIP to attach to the Wireguard instance."
}
...
variable "wg_server_private_key" {
  description = "The WG server private key."
}

variable "ami_id" {
  default = null
  # we check for this and use a data provider since we can't use it here
